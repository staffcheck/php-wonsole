...
web build:
 - http://mootools.net/core/f8979360aa7954c3e728d3be9b65de68

packager build:
 - packager build Core/Element.Style Core/Request.JSON Core/JSON Core/DOMReady
...
p[o]={};p.borderWidth[n]=p[o][n]=l[n]="@px";p.borderStyle[k]=p[o][k]=l[k]="@";p.borderColor[m]=p[o][m]=l[m]="rgb(@, @, @)";});})();(function(){var a=this.Class=new Type("Class",function(h){if(instanceOf(h,Function)){h={initialize:h};
